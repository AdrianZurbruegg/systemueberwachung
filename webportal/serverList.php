...
// Selects the required information of windows systems. Max(id) is needed to select the last entry. Without this, the query would return results for every entry in availabilityInfo.
...
// Selects the required information of linux systems. Max(id) is needed to select the last entry. Without this, the query would return results for every entry in availabilityInfo.
...
<div class="content_serverList">
                    ...
                    <table id="tbl_serverListWindows" class="highlight tbl_serverList">
                        ...
                        <?php foreach ($resultWindows as $row) { ?>
                            <tr>
                                ...
                                <td>
                                    <!-- Pass the hostInfo id as a paramater in the url -->
    ...
    <!-- END: Windows server list ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->

    <!-- START: Linux server list ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    <div class="row">
        <div class="col s12 m11">
            <h4>Linux Systeme:</h4>
            <div class="table-wrapper  z-depth-2">
...
<script type="application/x-javascript">
    ...
    // Sets the color of the dot which shows the ping status
